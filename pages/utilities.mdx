...
`controls.start` accepts a function, that can return a different set of animation settings for each animating component. Each of these components will provide the function anything passed to its `custom` prop.
