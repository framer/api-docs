...
`path` values rely on the measurement of the overall path length. Setting `strokeDasharray` to `0` will hide the path until Framer Motion can measure it.

```jsx
<motion.path strokeDasharray={0} />
```
