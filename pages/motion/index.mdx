...
Motion shares the simple animation and gesture API as the Framer X library, while maintaining HTML and SVG semantics.
...
Once installed, you can import Motion into your components.
