...
TypeScript type definitions for Framer Motion.
...
This object can contain `Orchestration` LINK TO ORCHESTRATION props like `delay`, that schedule the animation as a whole.
