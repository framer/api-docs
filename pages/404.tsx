            ...
            <Grid className="four-o-four">
                ...
                <Center className="error-graphic">
                    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="60">
                        <path d="M45.111 0v45H0z" fill={logoColors[0]} />
                        <path d="M22.556 45h22.555v15H22.556z" fill={logoColors[0]} opacity=".5" />
                        <path
                        ...
                        <path
                            ...
                            opacity=".5"
                        />
                        <path d="M200 0v45h-45.111z" fill={logoColors[2]} />
                        <path d="M177.444 45H200v15h-22.556z" fill={logoColors[2]} opacity=".5" />
                    </svg>
                </Center>
            </Grid>
            <Codebar />
