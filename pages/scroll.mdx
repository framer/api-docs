...
export default Template("Scroll component")
...
<APIProperty name="ScrollConfig.dragEnabled" />

<APIProperty name="ScrollConfig.wheelEnabled" />
...
<APIProperty name="ScrollConfig.scrollAnimate" />
